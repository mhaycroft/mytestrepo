...
use MichaelMagazineBundle\Entity\Publication;
use MichaelMagazineBundle\Form\PublicationType;
...
class PublicationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $publications = $em->getRepository('MichaelMagazineBundle:Publication')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MichaelMagazineBundle\Form\PublicationType', $publication);
    ...
    {
        $deleteForm = $this->createDeleteForm($publication);
        $editForm = $this->createForm('MichaelMagazineBundle\Form\PublicationType', $publication);
